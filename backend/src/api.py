...
async def frontend_explain_post(request: Request) -> dict[str, str]:
    ...
    logger.debug("result was processed from a server and passed to frontend")
    return result


def _process_server_data(data: str) -> dict[str, str]:
